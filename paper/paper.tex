...
\newcommand\dlabel[2]{\begin{array}{c}\mathcal{#1}\\#2\end{array}}
...
\begin{proof}
  ...
  let $\mathcal{F} \equiv
  \mathcal{D}''(N,\nobind{N},\weakenrulenil,\sequentrulemem\mathcal{E})$, which
...
\[
  \infer[\tysg_{E_1}]{
    ...
    \dlabel{D}{\mem{M}{\thunk{\tysg(A;B)}}}
  }\quad
  \infer[\tysg_{E_2}]{
    \mem{\snd(M)}{B(\fst(M))}
  }{
    \dlabel{E}{\mem{M}{\thunk{\tysg(A;B)}}}
  }
\]
}
\begin{proof}
