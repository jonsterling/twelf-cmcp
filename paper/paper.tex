...
\theorem{The standard application rule for the cartesian product of a family of
sets is admissible:
\[
  \infer[\typi_E]{
    \mem{\ap(M;N)}{B(N)}
...
\theorem{The two standard elimination rules for the disjoint union of a family of sets are admissible:
\[
  \infer[\tysg_{E_1}]{
    \mem{\fst(M)}{A}
  }{
    \dlabel{\dname D}{\mem{M}{\thunk{\tysg(A;B)}}}
  }\quad
  \infer[\tysg_{E_2}]{
    \mem{\snd(M)}{B(\fst(M))}
  }{
...
\begin{proof}
  ...
  The derivations of the elimination rules are constructed by induction on
  $\dname{D}$, which must be a canonical derivation of the following form:
  \[
    \infer[\dname{D}]{
      \mem{M}{\thunk{\tysg(A;B)}}
    }{
      ...
      \infer{
        \canmem{\pair(M_1,M_2)}{\tysg(A;B)}
      }{
        \infer{
          \mem{M_1}{A}
        }{
          \dlabel{\dname D_2}{\eval{M_1}{X}} &
          \dlabel{\dname D_3}{\eval{A}{A'}} &
          \dlabel{\dname D_4}{\canmem{X}{A'}}
        }&
        \infer[\dname D_5]{
          \mem{M_2}{B(M_1)}
        }{
          \dlabel{\dname D_6}{\eval{M_2}{Y}} &
          \dlabel{\dname D_7}{\eval{B(M_1)}{C}} &
          \dlabel{\dname D_8}{\canmem{Y}{C}}
        }
      }
    }
  \]

  The two elimination rules are derived as follows:
  \medskip
      ...
      \begin{gather*}
        \infer[\tysg_{E_1}]{
          ...
          \infer{
            ...
            \dlabel{\dname D_1}{\eval{M}{\pair(M_1,M_2)}} &
            \dlabel{\dname D_2}{\eval{M_1}{X}}
          } &
          \dlabel{\dname D_3}{\eval{A}{A'}} &
          \dlabel{\dname D_4}{\canmem{X}{A'}}
        ...
        \infer[\tysg_{E_2}]{
          ...
          \dlabel{\dname D_7}{\eval{B(\fst(M))}{C}} & % TODO: A little fishy
          \dlabel{\dname D_8}{\canmem{Y}{C}}
        }
      \end{gather*}
    \end{minipage}
